...
- `src/data/barter.json` (107 rows: notebook 70 + yenyen union; 6 `yen-` dups/conflicts dropped 2026-09-06, 4 more `yen-` twins dropped 2026-09-09 with user state remapped to the kept twin, then +5 new rows: edern/erin×2/cat-sea-bass/jennifer; +13 shops-orphan rows 2026-09-22 with readable get-item ids, all 視需求) is hand-owned. Full seed is notebook 70 tw as base, extended to yenyen 86 after diff, never include notebook 18 kr.
