...
2. **Report the diff** — added / removed / changed rows. If counts drift far
   from `docs/tracker-data.md` (21 tracker, 98 barter), flag for human review.
...
- `src/data/tracker.json` (21 TW rows, hand-owned), `src/data/barter.json` (98 rows, hand-owned)
