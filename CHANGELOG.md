...
- Floating-pill character switcher swapped from Radix Select (always scroll-locks: scrollbar vanishes, body padding shifts the fixed pill) to non-modal DropdownMenu radio list — page never moves; `ui/dropdown-menu` gains radio items
