...
- 9/9 barter refresh: silver-alloy chain added (艾頓 銀合金錠×10 每週必換; 貓商人鱸魚 feeds it; 艾琳 ×2 routes), col-a1 returns as 推薦 server-shared, all cat-merchant towns unified to 地下城、狩獵場. 艾頓 auto-pins on existing saves too (store v15→v16 appends only never-before-existing ids — old unpins untouched)
- 珍妮佛 清淡的肉×15 (黃豆×10, 每日必換) added with its 黃豆 gather route (收割 Lv.10); auto-pins on existing saves via the same v16 step
