...
- Floating pills use a solid fill meter instead of the horizontal bar: the pill background fills with progress at zero extra width (prototyped as `prototype/pill-progress`, fill won)
